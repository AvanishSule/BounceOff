...
if(movingRect.y - fixedRect.y < fixedRect.height/2 + movingRect.height/2 && fixedRect.x - movingRect.x < fixedRect.height/2 + movingRect.height/2{
    movingRect.velociyY = movingRect.velocityY * (-1);
